...
$_SESSION['message'] = "Hoja de cirugía refractiva guardada correctamente.";
$_SESSION['message_type'] = "success";

$stmt->close();
header("Location: reg_pro.php?tratamiento_exito=CIRUGÍA REFRACTIVA");
exit;
?>
