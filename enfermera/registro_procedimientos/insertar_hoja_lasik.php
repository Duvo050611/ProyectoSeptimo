...
$od_queratometria = $_POST['od_queratometria'] ?? '';
$od_microqueratomo = $_POST['od_microqueratomo'] ?? '';
$od_anillo = $_POST['od_anillo'] ?? '';
$od_tope = $_POST['od_tope'] ?? '';
$oi_queratometria = $_POST['oi_queratometria'] ?? '';
$oi_microqueratomo = $_POST['oi_microqueratomo'] ?? '';
$oi_anillo = $_POST['oi_anillo'] ?? '';
$oi_tope = $_POST['oi_tope'] ?? '';
...
$tipos = "sssssssssssssssssssssssssssssssssssss";
$parametros = [
    $id_atencion, $medico_tratante, $anestesiologo, $anestesia,
    $od_queratometria, $od_microqueratomo, $od_anillo, $od_tope,
    $oi_queratometria, $oi_microqueratomo, $oi_anillo, $oi_tope,
...
if (strlen($tipos) !== count($parametros)) {
    die("Error de depuración: tipos (".strlen($tipos).") y parámetros (".count($parametros).") no coinciden.");
}
...
$_SESSION['message'] = "Hoja de cirugía LASIK guardada correctamente.";
$_SESSION['message_type'] = "success";

$stmt->close();
header("Location: reg_pro.php?tratamiento_exito=CIRUGÍA LASIK");
exit;
?>
