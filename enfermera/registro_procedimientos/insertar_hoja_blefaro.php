...
$sql = "INSERT INTO blefaroplastia (
    ...
    nota_enfermeria, enfermera_responsable, fecha
) VALUES (
    ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?
)";
$stmt = $conexion->prepare($sql);

$tipos = "ssssssssssssssssssssssssssss";
$parametros = [
    $id_atencion, $medico_tratante, $anestesiologo, $anestesia,
    $pa_pre, $fr_pre, $temp_pre, $oxi_pre, $gluco_pre, $fc_pre, $hora_pre,
    $pa_dur, $fr_dur, $temp_dur, $oxi_dur, $gluco_dur, $fc_dur, $hora_dur,
...
$_SESSION['message'] = "Hoja de blefaroplastia guardada correctamente.";
$_SESSION['message_type'] = "success";

$stmt->close();
header("Location: reg_pro.php?tratamiento_exito=BLEFAROPLASTIA");
exit;
?>
