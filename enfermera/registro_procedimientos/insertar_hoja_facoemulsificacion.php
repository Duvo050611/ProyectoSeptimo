...
$sql = "INSERT INTO facoemulsificacion (
...
$_SESSION['message'] = "Hoja de facoemulsificación guardada correctamente.";
$_SESSION['message_type'] = "success";

$stmt->close();
header("Location: reg_pro.php?tratamiento_exito=FACOEMULSIFICACION");
exit;
?>
