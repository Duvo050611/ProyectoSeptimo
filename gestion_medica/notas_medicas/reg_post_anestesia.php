...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                ...
                <form action="insertar_reg_post_anestesia.php" method="POST" id="postAnestheticOcularForm"
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <div class="voice-controls">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_tecnica_anestesica"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_tecnica_anestesica"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_tecnica_anestesica"><i
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <div class="voice-controls">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_sangre_liquidos"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_sangre_liquidos"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_sangre_liquidos"><i
                                class="fas fa-play"></i></button>
                    </div>
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="incidentes" id="incidentes_si" value="Sí">
                        <label class="form-check-label" for="incidentes_si">Sí</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="incidentes" id="incidentes_no" value="No"
                            checked>
                        <label class="form-check-label" for="incidentes_no">No</label>
                    </div>
                    <div class="voice-controls mt-2">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_detalle_incidentes"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_detalle_incidentes"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_detalle_incidentes"><i
                                class="fas fa-play"></i></button>
                    </div>
                    <textarea class="form-control mt-2" name="detalle_incidentes" id="detalle_incidentes" rows="3"
                        placeholder="Ejemplo: Leve edema corneal observado, manejado con esteroides tópicos"
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <div class="voice-controls">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_plan_manejo"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_plan_manejo"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_plan_manejo"><i
                                class="fas fa-play"></i></button>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ta_ingreso" id="ta_ingreso"
                                placeholder="Ejemplo: 120/80" pattern="\d{2,3}/\d{2,3}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="fc_ingreso" id="fc_ingreso"
                                placeholder="Ejemplo: 72" min="0" max="300">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="fr_ingreso" id="fr_ingreso"
                                placeholder="Ejemplo: 16" min="0" max="100">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="sato2_ingreso" id="sato2_ingreso"
                                placeholder="Ejemplo: 98" min="0" max="100">
                            <div class="invalid-feedback">Debe estar entre 0 y 100.</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pio_ingreso" id="pio_ingreso"
                        placeholder="Ejemplo: OD 18, OS 16">
                ...
                <table class="table table-bordered aldrete-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>2</td>
                            <td><input type="radio" name="actividad_ingreso" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="actividad_hora_ingreso"></td>
                            <td><input type="radio" name="actividad_alta" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="actividad_hora_alta"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>2</td>
                            <td><input type="radio" name="respiracion_ingreso" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="respiracion_hora_ingreso"></td>
                            <td><input type="radio" name="respiracion_alta" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="respiracion_hora_alta"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>2</td>
                            <td><input type="radio" name="circulacion_ingreso" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="circulacion_hora_ingreso"></td>
                            <td><input type="radio" name="circulacion_alta" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="circulacion_hora_alta"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>2</td>
                            <td><input type="radio" name="conciencia_ingreso" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="conciencia_hora_ingreso"></td>
                            <td><input type="radio" name="conciencia_alta" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="conciencia_hora_alta"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>2</td>
                            <td><input type="radio" name="saturacion_ingreso" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="saturacion_hora_ingreso"></td>
                            <td><input type="radio" name="saturacion_alta" value="2"></td>
                            <td><input type="time" class="form-control time-input" name="saturacion_hora_alta"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <input type="number" class="form-control" name="total_ingreso" id="total_ingreso"
                                    readonly>
                                <input type="number" class="form-control mt-2" name="total_alta" id="total_alta"
                                    readonly>
                            </td>
                        </tr>
                    </tbody>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="hora_alta" id="hora_alta">
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <div class="voice-controls">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_evolucion_alta"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_evolucion_alta"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_evolucion_alta"><i
                                class="fas fa-play"></i></button>
                    </div>
                    <textarea class="form-control" name="evolucion_alta" id="evolucion_alta" rows="5"
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pio_alta" id="pio_alta"
                        placeholder="Ejemplo: OD 20, OS 15">
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <div class="voice-controls">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_control_dolor"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_control_dolor"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_control_dolor"><i
                                class="fas fa-play"></i></button>
                    </div>
                    <textarea class="form-control" name="control_dolor" id="control_dolor" rows="3"
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="estado_conciencia" id="consciente"
                            value="Consciente">
                        <label class="form-check-label" for="consciente">Consciente</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="estado_conciencia" id="somnoliento"
                            value="Somnoliento">
                        <label class="form-check-label" for="somnoliento">Somnoliento</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="estado_conciencia" id="inconsciente"
                            value="Inconsciente">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="dolor_ocular" id="dolor_ocular"
                            value="Sí">
                        <label class="form-check-label" for="dolor_ocular">Dolor Ocular</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="vision_borrosa" id="vision_borrosa"
                            value="Sí">
                ...
                <div class="form-group">
                    ...
                    <div class="voice-controls">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_evolucion_final"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_evolucion_final"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_evolucion_final"><i
                                class="fas fa-play"></i></button>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="deambulacion" id="deambulacion_si"
                            value="Sí">
                        <label class="form-check-label" for="deambulacion_si">Sí</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="deambulacion" id="deambulacion_no"
                            value="No">
                ...
                <div class="form-group">
                    ...
                    <div class="voice-controls">
                        <button type="button" class="btn btn-danger btn-sm" id="grabar_indicaciones_alta"><i
                                class="fas fa-microphone"></i></button>
                        <button type="button" class="btn btn-primary btn-sm" id="detener_indicaciones_alta"><i
                                class="fas fa-microphone-slash"></i></button>
                        <button type="button" class="btn btn-success btn-sm" id="reproducir_indicaciones_alta"><i
                                class="fas fa-play"></i></button>
                    </div>
    ...
    <!-- JavaScript for form handling and voice controls -->
    ...
    $(document).ready(function() {
        ...
        updateAldreteScores();
        $('input[name^="actividad_"], input[name^="respiracion_"], input[name^="circulacion_"], input[name^="conciencia_"], input[name^="saturacion_"]')
            .on('change', updateAldreteScores);
        ...
        fields.forEach(field => {
            ...
            recognition.onresult = (event) => {
                ...
                textarea.val(textarea.val() + (textarea.val() ? ' ' : '') + frase);
            };

            $(`#grabar_${field}`).on('click', () => recognition.start());
            $(`#detener_${field}`).on('click', () => recognition.stop());

            $(`#reproducir_${field}`).on('click', () => {
                const speech = new SpeechSynthesisUtterance($(`#${field}`).val());
                speech.volume = 1;
                speech.rate = 1;
                speech.pitch = 1;
                speech.lang = 'es-ES';
        ...
        $('#postAnestheticOcularForm').on('submit', function(event) {
            ...
            const requiredFields = ['ojo_operado', 'tecnica_anestesica', 'plan_manejo',
                'evolucion_final', 'indicaciones_alta'
            ];
            ...
            // Validate blood pressure fields if filled
            ['ta_ingreso', 'ta_alta', 'ta_final'].forEach(id => {
                const ta = $(`#${id}`);
                if (ta.val().trim() && !/^\d{2,3}\/\d{2,3}$/.test(ta.val())) {
                    isValid = false;
                    ta.addClass('is-invalid');
                    ta.siblings('.invalid-feedback').text(
                        'Formato: sistólica/diastólica (ej. 120/80).').show();
                }
            });
            ...
            const numericFields = [{
                ...
                {
                    id: 'horas_post_anestesia',
                    min: 0,
                    max: 999,
                    label: 'Horas Post Anestesia'
                }
            ];
            ...
            numericFields.forEach(field => {
                ...
                if (input.val().trim() && (isNaN(value) || value < field.min || (field.max &&
                        value > field.max))) {
                    isValid = false;
                    input.addClass('is-invalid');
            ...
            // Validate detalle_incidentes if incidentes is "Sí"
            if ($('#incidentes_si').is(':checked') && !$('#detalle_incidentes').val().trim()) {
                isValid = false;
                $('#detalle_incidentes').addClass('is-invalid');
                $('#detalle_incidentes').siblings('.invalid-feedback').text(
                    'Especifique los detalles de los incidentes.').show();
            }
